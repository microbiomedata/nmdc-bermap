# Contributing to nmdc-sfas-brcs

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
nmdc-sfas-brcs. These guidelines are not strict rules.
...
The nmdc-sfas-brcs team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the nmdc-sfas-brcs technical leads
...
[issues]: https://github.com/my-org/nmdc-sfas-brcs/issues/
[pulls]: https://github.com/my-org/nmdc-sfas-brcs/pulls/
